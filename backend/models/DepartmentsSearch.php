...
class DepartmentsSearch extends Departments
{
    ...
    {
        return [
            [['department_id', 'department_company_id'], 'integer'],
            [['department_name', 'department_created_date', 'department_status','branches_branch_id'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'department_name', $this->department_name])
            ...
            ->andFilterWhere(['like', 'departments.department_name', $this->department_company_id]);
